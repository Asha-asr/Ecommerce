	...
	<div class="col-xs-12 col-md-6">
		<!-- First product box start here-->
			<div class="prod-info-main prod-wrap clearfix">
				<div class="row">
						<?php
							require 'C:\xampp\htdocs\xampp\shop\classes\products.class.php';
							$objproducts = new products();
							$pdt = $objproducts->getAllproducts();
							foreach($pdt as $key => $products){
						?>
						
					<div class="col-md-6 col-sm-3 col-xs-3">
							<div class="product-image"> 
								<img src="images/<?php echo $products['productImage']; ?>" class="img-responsive"> 
								<span class="tag2 hot">
								NEW
								</span> 
							...
							<h5 class="name">
							<a href="#">
							<strong><?php echo $products['productName']; ?></strong>
							</a>
							<a href="#">
								<span></span>
							</a>                            
						...
						<p class="price-container">
							<span><p>Price: <strong>$ <?php echo $products['productPrice']; ?></strong></p></span>
						</p>
